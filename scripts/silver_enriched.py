...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Left-join silver trips with silver weather on (pickup_date, pickup_hour). Trips without matching weather keep null weather columns.",
...
def main() -> None:
    ...
    output = run_silver_enriched(spark_cfg)
    print(output)
